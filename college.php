 ...
 if(isset($_GET["submit"])){
     ...
     <div style="height: 40px"></div>  
     <div>
       <h2  class="cp-clg-h">CUT OFFs</h2>
       <?php 
       if(isset($_SESSION['email']) && $_SESSION['email']=='admin@dbms.com'){
         $s="college-cutoff-update.php?collegename=$collegename";
         echo "<a href=\"$s\" class=\"btn btn-outline-success my-2 my-sm-0\" role=\"button\">ADD</a>" ;     
       }
...
<section>
  ...
  <div style="padding: 40px">
   ...
   <h2  class="cp-clg-h">Colleges</h2><hr>
